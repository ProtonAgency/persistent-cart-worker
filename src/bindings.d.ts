...
declare global {
  ...
  interface CartItem {
    ...
    discounts: any[] // todo: discount type
    sku: string
    grams: number
    vendor: string
    taxable: boolean
    ...
    line_level_discount_allocations: any[] // todo: discount application type
  ...
  interface Cart {
    ...
    cart_level_discount_applications: Array<any> // todo: discount application type
  }
}
